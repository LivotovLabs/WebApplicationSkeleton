...
public class WebappsGuiceModule extends ServletModule
{
    ...
    private Map<String, String> createWicketFilterInitParams()
    {
        ...
        wicketFilterParams.put("applicationClassName", "com.knxcube.front.app.FrontApp"); //todo: replace package name (and maybe class name) after skeleton refactoring
