...
public abstract class QuartzModule extends AbstractModule
{
     ...
     * </pre>
     *
     * @see llabsapptemplatepkg.server.core.quartz.guice.JobSchedulerBuilder
     */
     ...
     */
    protected final llabsapptemplatepkg.server.core.quartz.guice.JobSchedulerBuilder scheduleJob(Class<? extends Job> jobClass)
    {
        try
        {
            llabsapptemplatepkg.server.core.quartz.guice.JobSchedulerBuilder builder = new llabsapptemplatepkg.server.core.quartz.guice.JobSchedulerBuilder(jobClass);
